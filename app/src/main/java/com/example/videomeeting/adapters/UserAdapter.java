...
public class UserAdapter extends RecyclerView.Adapter<UserAdapter.UserViewHolder>{
    ...
    class UserViewHolder extends RecyclerView.ViewHolder{
        ...
        UserViewHolder(@NonNull View itemView) {
            ...
            textUserName = itemView.findViewById(R.id.testUserName);
        ...
        void setUserData(User user){
            ...
            imageAudioMeeting.setOnClickListener(v -> usersListener.initialAudioMeeting(user));
            imageVideoMeeting.setOnClickListener(v -> usersListener.initialVideoMeeting(user));
